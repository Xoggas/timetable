...
public sealed class LessonTableControllerTests_Post : IClassFixture<MongoDbFixture>
{
    ...
    public LessonTableControllerTests_Post(MongoDbFixture dbFixture)
    {
        ...
        _lessonTablesBackupRepository = factory.Services.GetService<ILessonTablesBackupRepository>()!;
    ...
    public async Task Post_MakeBackup_WhenTableExists_ShouldReturnTheSameTable()
    {
        ...
        Assert.Equal(updateLessonTableDto.Lessons, createdBackup.Lessons);
    }
    ...
    {
        const DayOfWeek dayOfWeek = DayOfWeek.Thursday;
        ...
        Assert.Equal(updateLessonTableDtoBeforeBackup.Lessons, restoredLessonTable.Lessons);
